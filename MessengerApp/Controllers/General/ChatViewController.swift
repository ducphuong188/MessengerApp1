...
final class ChatViewController: MessagesViewController {
    ...
    private var selfSender: Sender? {
        guard let email = Core.shared.getCurrentUserEmail() as? String else {
            return nil
        }
...
extension ChatViewController: InputBarAccessoryViewDelegate {
    ...
    private func createMessageId() -> String? {
        ...
        guard let currentUserEmail = Core.shared.getCurrentUserEmail() as? String else { return "" }
...
extension ChatViewController: MessagesDataSource, MessagesLayoutDelegate, MessagesDisplayDelegate {
    ...
    func configureAvatarView(_ avatarView: AvatarView, for message: MessageType, at indexPath: IndexPath, in messagesCollectionView: MessagesCollectionView) {
        ...
        if sender.senderId == selfSender?.senderId {
            ...
            let originEmail = DatabaseManager.shared.restoreEmail(safeEmail: self.otherUserEmail)
...
extension ChatViewController: MessageCellDelegate {
    func didTapAvatar(in cell: MessageCollectionViewCell) {
        ...
        if message.sender.senderId == selfSender?.senderId {
           ...
           let safeEmail = DatabaseManager.shared.restoreEmail(safeEmail: email)
            vc.email = safeEmail
        }
